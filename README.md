...
- навыки из [firecrawl/skills](https://github.com/firecrawl/skills): готовые сценарии поиска, извлечения, обхода, разбора файлов и структурированного сбора данных из открытых источников.
...
Правила работы агента вынесены в [prompts/system-prompt.md](prompts/system-prompt.md). В этом файле описаны источники, порядок поиска, требования к DOI, резюме, переводу и научному анализу.
...
Проект оформлен как готовый отчётный пакет: плагин, подключение MCP, подробный промпт, отчёт и схема работы агента.
